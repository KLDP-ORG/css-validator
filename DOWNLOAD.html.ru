...
<kbd>java -jar css-validator.jar http://www.w3.org/</kbd></p>
  ...
  <li><a href="DOWNLOAD.html.de"
   ...
   <p id="activity_logos">
      ...
      <a href="http://www.w3.org/QA/" title="Сообщество контроля качества W3C, распространяющее бесплатные утилиты"><img src="//validator.kldp.org/QA/2002/12/qa-small.png" alt="Сообщество контроля качества" /></a><a href="http://www.w3.org/Style/CSS/learning" title="Узнайте больше о CSS"><img src="images/woolly-icon" alt="CSS" /></a>
   </p>
